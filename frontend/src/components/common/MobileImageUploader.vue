<template>
  <div class="relative w-full aspect-square bg-gray-50 border-2 border-dashed rounded-xl overflow-hidden group flex items-center justify-center transition-all shadow-sm"
       :class="borderClass">
    ...
    <template v-if="modelValue">
      ...
      <div v-if="imageLoadError" class="absolute inset-0 bg-red-50 flex flex-col items-center justify-center">
    ...
    <template v-else-if="!isUploading && !uploadError">
      <div class="flex flex-col items-center justify-center w-full h-full p-4 gap-2.5">
        <label class="cursor-pointer flex items-center justify-center gap-2 w-full py-2.5 bg-white border border-gray-200 shadow-sm rounded-[10px] text-primary-600 hover:bg-gray-50 active:scale-95 transition-all">
        ...
        <label class="cursor-pointer flex items-center justify-center gap-2 w-full py-2.5 bg-gray-100 rounded-[10px] text-gray-700 hover:bg-gray-200 active:scale-95 transition-all">
    ...
    <template v-else-if="uploadError">
      <div class="flex flex-col items-center justify-center p-3 text-center">
        ...
        <div class="flex gap-2">
          ...
          <label class="text-[10px] px-2.5 py-1 bg-gray-200 text-gray-700 rounded-lg font-bold cursor-pointer">
            Chọn khác
...
const borderClass = computed(() => {
  if (uploadError.value) return 'border-red-300 bg-red-50'
