<template>
  <div class="space-y-4 md:space-y-6 pb-24 md:pb-0">
    ...
    <div class="md:hidden flex flex-col gap-2">
      ...
      <p class="text-sm leading-relaxed text-gray-500">Quản lý tài khoản và phân quyền thao tác.</p>
    </div>
    ...
    <div v-else class="space-y-4 md:space-y-6">
      <div class="hidden lg:block bg-dark-surface rounded-xl overflow-hidden border border-gray-700/50 shadow-lg shadow-black/10">
        <table class="w-full">
          <thead class="bg-dark-bg border-b border-gray-700/50">
            <tr>
              ...
              <th class="px-4 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wide">Ngày tạo</th>
        ...
        <div v-if="users.length === 0" class="px-6 py-10 text-center text-gray-500">
    ...
    <div v-if="showDeleteConfirm" class="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div class="relative bg-dark-surface rounded-[24px] md:rounded-xl shadow-xl w-full max-w-sm p-5 md:p-6">
        ...
        <div class="flex gap-3">
          ...
          <button @click="deleteUser" :disabled="deleting" class="flex-1 min-h-[52px] rounded-xl bg-red-600 text-white font-semibold hover:bg-red-700 disabled:opacity-50 transition-colors">
